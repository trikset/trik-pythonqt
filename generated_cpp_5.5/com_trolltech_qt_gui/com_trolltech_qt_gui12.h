...
inline void promoted_registerField(const QString&  name, QWidget*  widget, const char*  property = 0, const char*  changedSignal = 0) { this->registerField(name, widget, property, changedSignal); }
