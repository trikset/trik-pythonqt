...
void PythonQtWrapper_QSslPreSharedKeyAuthenticator::swap(QSslPreSharedKeyAuthenticator* theWrappedObject, QSslPreSharedKeyAuthenticator&  authenticator)
{
  ( theWrappedObject->swap(authenticator));
}
