...
void PythonQtWrapper_QJsonObject::remove(QJsonObject* theWrappedObject, QLatin1String  key)
{
...
QJsonValue  PythonQtWrapper_QJsonObject::take(QJsonObject* theWrappedObject, QLatin1String  key)
{
