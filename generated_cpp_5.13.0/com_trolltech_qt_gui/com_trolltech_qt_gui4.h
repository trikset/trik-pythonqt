...
static inline QPixmap  promoted_selectedPixmap(const QPixmap&  pixmap, const QPalette&  palette, bool  enabled) { return this->selectedPixmap(pixmap, palette, enabled); }
