...
PythonQt::priv()->registerCPPClass("QSignalBlocker", "", "QtCore", PythonQtCreateObject<PythonQtWrapper_QSignalBlocker>, PythonQtSetInstanceWrapperOnShell<PythonQtShell_QSignalBlocker>, module, 0);
