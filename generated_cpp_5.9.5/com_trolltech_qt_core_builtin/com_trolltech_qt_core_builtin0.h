...
{ Q_OBJECT
public:
Q_ENUMS(Country CurrencySymbolFormat FloatingPointPrecisionOption FormatType Language MeasurementSystem NumberOption QuotationStyle Script )
