...
void delete_QScreen(QScreen* obj) { delete obj; } 
   ...
   QScreen*  virtualSiblingAt(QScreen* theWrappedObject, const QPoint&  point);
...
public:
    ...
    PythonQtShell_QShortcut(const QKeySequence&  key, QWidget*  parent, const char*  member = nullptr, const char*  ambiguousMember = nullptr, Qt::ShortcutContext  shortcutContext = Qt::WindowShortcut):QShortcut(key, parent, member, ambiguousMember, shortcutContext),_wrapper(NULL) {};
...
{
public:
    PythonQtShell_QSplashScreen(QScreen*  screen, const QPixmap&  pixmap = QPixmap(), Qt::WindowFlags  f = Qt::WindowFlags()):QSplashScreen(screen, pixmap, f),_wrapper(NULL) {};
