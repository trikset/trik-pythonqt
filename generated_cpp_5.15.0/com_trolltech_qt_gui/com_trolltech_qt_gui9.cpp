...
void PythonQtWrapper_QTabBar::setTabVisible(QTabBar* theWrappedObject, int  index, bool  arg__2)
{
  ( theWrappedObject->setTabVisible(index, arg__2));
}
...
void PythonQtWrapper_QTabWidget::setTabVisible(QTabWidget* theWrappedObject, int  index, bool  arg__2)
{
  ( theWrappedObject->setTabVisible(index, arg__2));
}
