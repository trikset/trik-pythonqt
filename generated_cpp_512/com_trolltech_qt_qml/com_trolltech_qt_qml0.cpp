...
QJSValue  PythonQtWrapper_QJSEngine::newQMetaObject(QJSEngine* theWrappedObject)
{
  return ( theWrappedObject->newQMetaObject());
}
...
QJSValue  PythonQtWrapper_QQmlEngine::singletonInstance<QJSValue>(QQmlEngine* theWrappedObject, int  qmlTypeId)
{
  return ( theWrappedObject->singletonInstance<QJSValue>(qmlTypeId));
}
