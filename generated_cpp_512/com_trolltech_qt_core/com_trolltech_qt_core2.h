...
public slots:
   ...
   QString  locate(QStandardPaths* theWrappedObject, QStandardPaths::StandardLocation  type, const QString&  fileName, QStandardPaths::LocateOptions  options = QStandardPaths::LocateFile);
