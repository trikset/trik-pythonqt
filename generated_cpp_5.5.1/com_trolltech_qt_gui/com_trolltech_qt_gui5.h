...
Q_FLAGS(DockOptions )
enum DockOption{
  AnimatedDocks = QMainWindow::AnimatedDocks,   AllowNestedDocks = QMainWindow::AllowNestedDocks,   AllowTabbedDocks = QMainWindow::AllowTabbedDocks,   ForceTabbedDocks = QMainWindow::ForceTabbedDocks,   VerticalTabs = QMainWindow::VerticalTabs};
...
{
public:
    PythonQtShell_QOpenGLWidget(QWidget*  parent = 0, Qt::WindowFlags  f = 0):QOpenGLWidget(parent, f),_wrapper(NULL) {};
...
public slots:
QOpenGLWidget* new_QOpenGLWidget(QWidget*  parent = 0, Qt::WindowFlags  f = 0);
...
{
public:
    PythonQtShell_QOpenGLWindow(QOpenGLContext*  shareContext, QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = 0):QOpenGLWindow(shareContext, updateBehavior, parent),_wrapper(NULL) {};
    PythonQtShell_QOpenGLWindow(QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = 0):QOpenGLWindow(updateBehavior, parent),_wrapper(NULL) {};
...
public slots:
QOpenGLWindow* new_QOpenGLWindow(QOpenGLContext*  shareContext, QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = 0);
QOpenGLWindow* new_QOpenGLWindow(QOpenGLWindow::UpdateBehavior  updateBehavior = QOpenGLWindow::NoPartialUpdate, QWindow*  parent = 0);
