...
void PythonQtShell_QVBoxLayout::childEvent(QChildEvent*  event0)
{
if (_wrapper && (((PyObject*)_wrapper)->ob_refcnt > 0)) {
...
QLayoutItem*  PythonQtShell_QVBoxLayout::itemAt(int  index0) const
{
if (_wrapper && (((PyObject*)_wrapper)->ob_refcnt > 0)) {
...
QLayoutItem*  PythonQtShell_QVBoxLayout::takeAt(int  index0)
{
if (_wrapper && (((PyObject*)_wrapper)->ob_refcnt > 0)) {
...
int  PythonQtShell_QWidget::metric(QPaintDevice::PaintDeviceMetric  metric0) const
{
if (_wrapper && (((PyObject*)_wrapper)->ob_refcnt > 0)) {
