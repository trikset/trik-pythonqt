...
public:
    ...
    PythonQtShell_QOpenGLPaintDevice(int  x, int  y, int  width, int  height):QOpenGLPaintDevice(x, y, width, height),_wrapper(NULL) {};
...
QOpenGLPaintDevice* new_QOpenGLPaintDevice(int  x, int  y, int  width, int  height);
void delete_QOpenGLPaintDevice(QOpenGLPaintDevice* obj) { delete obj; } 
   ...
   QPoint  offset(QOpenGLPaintDevice* theWrappedObject) const;
