...
QOpenGLPaintDevice* PythonQtWrapper_QOpenGLPaintDevice::new_QOpenGLPaintDevice(int  x, int  y, int  width, int  height)
{ 
return new PythonQtShell_QOpenGLPaintDevice(x, y, width, height); }
...
QPoint  PythonQtWrapper_QOpenGLPaintDevice::offset(QOpenGLPaintDevice* theWrappedObject) const
{
